...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_planck_grid(
      ...
      LCTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,  KC_G,     KC_H,     KC_J,   KC_K,    KC_L,    KC_SCLN, MT(MOD_RSFT, KC_QUOT),
      KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,     KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RGUI, KC_ENT),
  ...
  */
  [_LOWER] = LAYOUT_planck_grid(
      ...
      XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ASTR,  KC_4,     KC_5,    KC_6,     KC_MINS,  S(KC_SCLN), 
  ...
  */
  [_RAISE] = LAYOUT_planck_grid(
      ...
      XXXXXXX,  KC_GRV,  KC_PLUS, KC_SLSH, KC_LCBR,  KC_LBRC,  KC_RBRC,  KC_RCBR, KC_BSLS, KC_MINS, KC_EQL,  XXXXXXX, 
      XXXXXXX,  KC_PGDN, KC_PGUP, XXXXXXX, KC_LPRN,  XXXXXXX,  XXXXXXX,  KC_RPRN, XXXXXXX, XXXXXXX, KC_PLUS, KC_ENT, 
