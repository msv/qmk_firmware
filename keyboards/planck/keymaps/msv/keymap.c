...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_planck_grid(
      ...
      LCTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,              KC_G,     KC_H,     KC_J,   KC_K,    KC_L,    KC_SCLN, RCMD_T(KC_QUOT),
      KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_V,              KC_B,     KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_PIPE),
      KC_LCTL,         FN,      KC_LALT, KC_LGUI, LT(LOWER, KC_ENT), SPACE_FN, SPACE_FN, RAISE,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
